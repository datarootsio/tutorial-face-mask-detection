...
## Getting Started for Reproduce Face Mask Detection Model
If you do not want to recreate the `data` folder and retrain `masked or not masked` classifier model, you can skip this section.
